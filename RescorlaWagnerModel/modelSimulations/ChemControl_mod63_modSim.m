function [out] = ChemControl_mod63_modSim(parameters, subj)
    ...
    for t = 1:T
        ...
        v_pe = o - sv(s)/rho;
        sv(s) = sv(s) + ep * (1-omega) * (rho * o - sv(s));
        ...
        if a==1
            ...
            q_g(s) = q_g(s) + ep *omega* (rho * o - q_g(s));
            p_explore = 1-p1;
        ...
        elseif a==2
            ...
            q_ng(s) = q_ng(s) + ep *omega* (rho * o - q_ng(s));
            p_explore = p1;
