...
priors{18} = struct('mean', [0 2 0 0 0], 'variance', [3 5 10 10 5]); % prior_model_fixedPavlov
...
priors{23} = struct('mean', [0 2 0 0 0], 'variance', [3 5 10 10 5]); % prior_model_fixedPavlov
