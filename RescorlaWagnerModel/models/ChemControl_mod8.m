function [loglik] = ChemControl_mod8(parameters,subj)
...
for b = 1:B
    ...
    Lstate= zeros(4, 1)+omegaStartingBias;
    ...
    for t=1:T
        ...
        w_g(s) = goBias + (q_g(s)+sv(s))*(1-omegaState(s))+ mb_g*omegaState(s);
        w_ng(s) = (-sv(s)+q_ng(s))*(1-omegaState(s))+ mb_ng*omegaState(s);
