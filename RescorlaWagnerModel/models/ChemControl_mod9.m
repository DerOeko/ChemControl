function [loglik] = ChemControl_mod9(parameters,subj)

% this model only differs from 7 by implementing:
% absolute PE tracking for Omega estimation
% bounded omega transform
...
lapse_bounds=0.5*sigmoid(parameters(7)); % cannot be bigger than 0.5
...
for b = 1:B
    ...
    for t=1:T
        ...
        % bounded controllabiltiy arbitration
