function [loglik] = ChemControl_mod1(parameters,subj)

% Standard Rescorla Wagner model with rho feedback sensitivity
% ----------------------------------------------------------------------- %
%% Retrieve parameters:
...
for b = 1:B
    ...
    for t=1:T
        ...
        if a==1
            ...
            q_g(s) = q_g(s) + ep * (rho * o - q_g(s)); % Model is making value prediction for rho * o.
        elseif a==2
